<template>
  <form @submit.prevent="handleSubmit">
    <div class="mb-3">
      ...
      <input required type="number" v-model="editable.bedrooms" class="form-control" id="bedrooms"
        placeholder="bedrooms..." name="bedrooms">
    </div>
    <div class="mb-3">
      <label for="bathrooms" class="form-label">bathrooms</label>
      <input required type="number" v-model="editable.bathrooms" class="form-control" id="bathrooms"
    ...
    <div class="mb-3">
      ...
      <input required type="text" v-model="editable.imgUrl" class="form-control" id="imgUrl" placeholder="img..."
        name="imgUrl">
    </div>
    <div class="mb-3">
